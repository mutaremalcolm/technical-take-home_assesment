        ...
        <div className={`fixed top-0 left-0 w-full z-50 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'}`}>
            <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
                <a className="block w-[12rem] xl:mr-8" href="#hero">
                    <h1 className="font-code text-3xl uppercase text-n-1 transition-colors
                     hover:text-color-1">ClearScore</h1>
                </a>
          ...
          <MenuSvg openNavigation={openNavigation} />
                ...
                <button className="flex flex-row mr-15 font-code text-n-1 transition-colors hover:text-color-1">
                    <Logs />
                    Sort
                </button>
